                ...
                <div className="mx-auto max-w-7xl pt-16 sm:pt-20 pb-20 banner-image">
                    <div className="text-center">
                        <h1 className="text-2xl font-semibold text-navyblue sm:text-3xl  lg:text-5xl md:4px lh-66">
                            Market driven systems, <br /> built on industry proven technologies
                        </h1>
                        <p className="mt-6 text-lg leading-8 text-bluegray" >
                            Sentinel — leading gym membership management software. <br />sysPOS — the all-in-one POS solution for gyms and small retailers.
                        </p>
                    </div>
